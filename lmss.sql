...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 13 juil. 2021 à 10:37
...
('Harold', '555555', 'mola', 'boruto', 5),
('arthur', '655586299', 'atlarthur04@gmail.com', 'boruto', 3),
('asadgfd', '454', 'fdfd', 'le seed', 5);
...
('asadgfd', '3121', 'le seed', '2021-07-10', '2021-07-17', 'Emprunté', 1),
...
('naruto shippuden', 'manga', '2013-10-07', 'tv tokyo', 'Masashi', '2021-07-04', 22, 18),
('boruto', 'anime', '2018-07-12', 'tv tokyo', 'kishimoto', '2021-07-04', 30, 30),
('le seed', 'magazine', '1885-12-07', 'inter_etat', 'junior', '2021-07-07', 10, 18),
...
CREATE TABLE IF NOT EXISTS `stats_livre` (
  ...
  `Nom_Adherent` time DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
